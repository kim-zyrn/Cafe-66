...
<head>
  ...
  <title><?= $category_name = $_GET['general_category']; ?> - Cafe 66</title>
...
<div class="page-bc" id="page-bc">
  <h1><?= $category_name = $_GET['general_category']; ?></h1>
    <ul class="breadcrumb">
      <li><a href="home.php">Home</a></li>
      <li><?= $category_name = $_GET['general_category']; ?></li>
    </ul>
</div>
...
<div class="main-container" style="margin-top: 50px;">
  <div class="filter-container">
    ...
    <section class="products">
      <div class="row">
        <?php
        $category_name = $_GET['general_category'];
        $select_products = $conn->prepare("SELECT * FROM `products` WHERE general_category = ?");
        ...
        <form class="col-lg-3 col-sm-6" action="" method="POST">
          <div class="box">
            <div class="item">
              ...
              <input type="hidden" name="p_price" value="<?= $fetch_products['price1']; ?>">
