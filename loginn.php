...
<body>
  ...
  <div class="container" style="background-image: url(assets/images/admin_login.jpg); background-attachment: fixed;">
    <div class="img">
    </div>
    <div class="login-content">
      <form action="" method="POST">
        ...
        <h2 class="title" style="color:#000;">Login to your Account</h2>
