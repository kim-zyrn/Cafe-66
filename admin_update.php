...
<head>
  ...
  <title>Profile Update - Cafe 66</title>
 ...
 <div class="update-profile">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <input type="submit" class="update-admin" value="Update Profile" style="font-size: 20px;  letter-spacing: 3px;" name="update_profile">
