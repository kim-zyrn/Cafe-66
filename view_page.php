    ...
    <form class="row" action="" method="POST">
      ...
      <div class="col-lg-6">
        <div class="content">
          ...
          <div class="buttons">
            <span class="button cart"><input type="submit" name="add_to_cart" value="Add to Cart" style="background:transparent;color:#fff;"><i class="bi bi-cart"></i></span>
            <span class="button wishlist"><input type="submit" name="add_to_wishlist" value="Add to Wishlist" style="background:transparent;color:#fff;"><i class="bi bi-heart"></i></span>
          </div>
