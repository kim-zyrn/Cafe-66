    ...
    <div class="box">
      <figure class="product-thumb">
        ...
        <div class="action-links">
          ...
          <button class="menu-btn"><a href="general_category.php?general_category=Hot Latte">See More <i class="bi bi-arrow-right-circle"></i></a></button>
        </div>
      </figure>
    </div>
    <div class="box">
      <figure class="product-thumb">
        ...
        <div class="action-links">
          ...
          <button class="menu-btn"><a href="general_category.php?general_category=Milktea">See More <i class="bi bi-arrow-right-circle"></i></a></button>
        </div>
      </figure>
    </div>
    <div class="box">
      <figure class="product-thumb">
        ...
        <div class="action-links">
          ...
          <button class="menu-btn"><a href="general_category.php?general_category=Iced Coffee">See More <i class="bi bi-arrow-right-circle"></i></a></button>
        </div>
      </figure>
    </div>
    <div class="box">
      <figure class="product-thumb">
        ...
        <div class="action-links">
          ...
          <button class="menu-btn"><a href="general_category.php?general_category=Non Coffee">See More <i class="bi bi-arrow-right-circle"></i></a></button>
        </div>
      </figure>
    </div>
    <div class="box">
      <figure class="product-thumb">
        ...
        <div class="action-links">
          ...
          <button class="menu-btn"><a href="general_category.php?general_category=Italian Soda">See More <i class="bi bi-arrow-right-circle"></i></a></button>
        </div>
      </figure>
    </div>
...
<div class="seller-heading">
	<div class="heading-margin">
	  <h1 id="heading">BEST SELLER</h1>
	  <p id="sub-heading">Best Selling Products This Week!</p>
	</div>
  </div>
...
<script>
  $(document).ready(function(){
    $('select[name="p_size"]').change(function(){
      var size = $(this).val();
      var price = $('input[name="p_price"]').val();
      var new_price = price * size;
      $('input[name="p_price"]').val(new_price);
    });
  });
</script>
